...
INSERT INTO catalog_variant (
    ...
    ((SELECT id FROM catalog_product WHERE code = 'tomato'), 'TOMATO-1KG', 1.000, 'kg', 40, 'INR', TRUE, 0, FALSE, 'tomato', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'tomato'), 'TOMATO-5KG', 5.000, 'kg', 180, 'INR', TRUE, 0, FALSE, 'tomato', 20, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'onion'), 'ONION-1KG', 1.000, 'kg', 35, 'INR', TRUE, 0, FALSE, 'onion', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'onion'), 'ONION-5KG', 5.000, 'kg', 160, 'INR', TRUE, 0, FALSE, 'onion', 20, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'potato'), 'POTATO-1KG', 1.000, 'kg', 30, 'INR', TRUE, 0, FALSE, 'potato', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'potato'), 'POTATO-5KG', 5.000, 'kg', 140, 'INR', TRUE, 0, FALSE, 'potato', 20, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'brinjal'), 'BRINJAL-1KG', 1.000, 'kg', 45, 'INR', TRUE, 0, FALSE, 'brinjal', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'spinach'), 'SPINACH-1BN', 1.000, 'bunch', 20, 'INR', TRUE, 0, FALSE, 'spinach', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'gongura'), 'GONGURA-1BN', 1.000, 'bunch', 25, 'INR', TRUE, 0, FALSE, 'gongura', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'coriander'), 'CORIANDER-1BN', 1.000, 'bunch', 10, 'INR', TRUE, 0, FALSE, 'coriander', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'banana'), 'BANANA-1DZ', 1.000, 'dozen', 60, 'INR', TRUE, 0, FALSE, 'banana', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'mango'), 'MANGO-1KG', 1.000, 'kg', 120, 'INR', TRUE, 0, FALSE, 'mango', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'papaya'), 'PAPAYA-1PC', 1.000, 'pc', 40, 'INR', TRUE, 0, FALSE, 'papaya', 10, TRUE),
    ...
    ((SELECT id FROM catalog_product WHERE code = 'curd'), 'CURD-500G', 0.500, 'kg', 35, 'INR', TRUE, 0, FALSE, 'curd', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'paneer'), 'PANEER-200G', 0.200, 'kg', 80, 'INR', TRUE, 500, FALSE, 'paneer', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'rice-sona-masoori'), 'RICE-SM-5KG', 5.000, 'kg', 300, 'INR', TRUE, 0, FALSE, 'rice', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'rice-sona-masoori'), 'RICE-SM-25KG', 25.000, 'kg', 1450, 'INR', TRUE, 0, TRUE, 'rice', 20, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'toor-dal'), 'TOORDAL-1KG', 1.000, 'kg', 140, 'INR', TRUE, 500, FALSE, 'toor-dal', 10, TRUE),
    ((SELECT id FROM catalog_product WHERE code = 'ragi'), 'RAGI-1KG', 1.000, 'kg', 70, 'INR', TRUE, 500, FALSE, 'ragi', 10, TRUE);
